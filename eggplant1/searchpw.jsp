...
<tr height="25">
	...
	<td width="150" style="padding-left: 5px;">
	<input type="text" name="userPhoneNum" maxlength="20" size="15"/>
	</td>
</tr>
...
<tr height="30">
	...
	<input type="button" value=" 확인 " class="btn2" onclick="pw();"/> 
	<input type="button" value=" 취소 " class="btn2" onclick="location='<%=cp%>/eggplant/login.do';"/> 
	</td>
</tr>	
</table>
</form>
