...
<tr height="25">
	<td width="120" bgcolor="#e6e4e6" align="center">아이디</td>
...
<tr height="25">
	<td width="120" bgcolor="#e6e4e6" align="center">패스워드</td>
	<td width="120" style="padding-left: 5px;">
	<input type="password" name="userPassword" maxlength="10" size="15"/>
	</td>
</tr>
...
<tr height="30">
	...
	<input type="button" value=" 회원가입 " class="btn2" 
		onclick="location='<%=cp %>/eggplant/created.do';"/> 
	</td>
</tr>

<c:if test="${searchpwd==true }">
<tr height="30">
	<td colspan="2" align="center">		
	...
	<td colspan="2"><a href="searchpw.do">비밀번호 찾기</a></td>
	</tr>
